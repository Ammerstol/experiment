...
run_mk2_mcmc <- function(proba_x_100, chain_length, exp, prior_mean = 2, seed = 1){
  phy <- read.nexus(paste("experiment_beast/beast_tree_", proba_x_100, "_exp_", exp, ".nex", sep = ""))
...
write.csv(df, "experiment_beast/output_beast_tree_experiment.csv", row.names=FALSE)
